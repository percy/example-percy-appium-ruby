...
be able to follow along if you're not familiar with Ruby, Appium, but we won't
spend time introducing Ruby, Appium concepts.
...
```bash
$ git clone https://github.com/percy/example-percy-appium-ruby.git
$ cd example-percy-appium-ruby
$ make install
```
...
This will run the app's Ruby Appium tests, which contain calls to create Percy screenshots. The screenshots
